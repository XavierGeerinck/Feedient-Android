 ...
 */
public class FeedientCardArrayAdapter extends BaseCardArrayAdapter implements UndoBarController.UndoListener {
     ...
     */
    public FeedientCardArrayAdapter(Context context, List<Card> cards) {
        super(context, cards);
    }
...
//            }
            ...
            // Disable reusing of views and re-create it, this are cards
            view = mInflater.inflate(layout, parent, false);
        ...
        public void onDismiss(ListView listView, int[] reverseSortedPositions) {
            ...
            if (isEnableUndo() && mUndoBarController!=null){
                ...
                if (getUndoBarController().getUndoBarUIElements()!=null){
                    //messageUndoBar = getUndoBarController().getUndoBarUIElements().getMessageUndo((CardArrayAdapter)FeedientCardArrayAdapter.this,itemIds,itemPositions);
                }
